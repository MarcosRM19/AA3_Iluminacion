...
private:
    ...
    float initAngle, elapsedTime, radius, orbitTime, angle, alphaValue;
...
public:
    OrbitPrimitive(glm::vec4 _color, Model model, float initAngle, float radius, float orbitTime, bool interpolateColor);
